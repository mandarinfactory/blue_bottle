...
window.main3Arr=[
  {
    ...
    cup : "./img/object/main_cup04.png",
    img : "./img/grid/bb_grid18.jpg",
  },
  {
    title : 'single origin',
    desc : "Ethiopia Gedeb METAD Natural <br><br> Every holiday season, we find ourselves craving this single origin. An unintentional annual feature, Ethiopia Gedeb METAD Natural calls to us when the holiday excitement is in full swing. With floral notes of honey and tart blueberry jam this naturally processed coffee boasts an overt fruitiness and complexity that dazzles and enlivens— the perfect accompaniment to all holiday gatherings.",
    cup : "./img/object/main_cup03.png",
